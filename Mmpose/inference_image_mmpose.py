...
path_config = "/DATA/data/github_reference_for_clover/mmpose/configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/"
# path_model = "/storages/data/DATA/openposedata/Models/"
path_model = "/DATA/data/Project_GG/Clover/core/main/fall_detection/Mmpose/Models/"
...
def mmpose_inference(boxes, image):
    """
    list box in frame
    :param boxes: [[     2198.6      281.63      2283.6      450.35]]
    :param image:
    :return:
    """
    person_results = []

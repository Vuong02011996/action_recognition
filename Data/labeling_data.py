...
def label_7_class():
    ...
    video_folder = '/storages/data/DATA/Action_Recognition/DataTraining/Videos/Office2/Videos'
    # annot_file = '../Data/Home_new.csv'
    annot_file_2 = '/storages/data/DATA/Action_Recognition/DataTraining/Videos/Office2/Office_02.csv'
...
def label_2_class():
    ...
    path_video_train = "/storages/data/DATA/Action_Recognition/DataTraining/Videos/"
    video_list = sorted(os.listdir(path_video_train))
    print(video_list)

    video_folder = '/storages/data/DATA/Action_Recognition/DataTraining/Videos/Coffee_room_02/Videos'
    annot_file = '/storages/data/DATA/Action_Recognition/DataTraining/Videos/Coffee_room_02/Coffee_room_02_2_class.csv'
        ...
        while True:
            ...
            if ret:
                ...
                frame = cv2.putText(frame,
                                    'Video: {} - {}/{}   Total_frames: {}        Frame: {}       Pose: {} '.format(
                                        video_list[index_video_to_play], index_video_to_play + 1, len(video_list),
                                        frames_count, i + 1, cls_name, ),
                                    (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2)

                # Show button list
                frame = cv2.putText(frame, 'Back:  a', (10, 270), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)
                frame = cv2.putText(frame, 'Normal:   d', (10, 300), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 2)
                frame = cv2.putText(frame, 'Fal down:    k', (10, 330), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 2)
                ...
                if key == ord('q'):
                    break
                elif key == ord('d'):  # normal
                    i += 1
                    k = 0
                elif key == ord('k'):  # fall down
                    i += 1
                    k = 1
                elif key == ord('a'):  # back
                    i -= 1
